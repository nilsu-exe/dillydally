...
## 💡 About
This project uses **Computer Vision** to recreate the iconic "digital rain" aesthetic from *The Matrix*. It captures live video, removes the background using AI segmentation, and reconstructs the user's image using colored text characters./n
